...
const BUNDLE = [
  ...
  { id: 'death-certificates', phase: 'FIRST', cat: 'finance', label: 'Order death certificates (get 10+ copies)', stakes: 'high', assistType: 'jurisdiction',
    ...
    guidance: "1. Contact your local vital records office (or ask the funeral home to order them for you — they often do this as part of their services). 2. Request at least 10-15 certified copies — banks, insurance, Social Security, and creditors will all ask for originals. 3. Ask about rush processing if available. 4. There's a fee per copy, which your county sets — ask when you call. Shipping varies. 5. Keep the originals in a safe place; you'll reference them frequently over the next months." },
