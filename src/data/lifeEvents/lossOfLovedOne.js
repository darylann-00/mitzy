...
const BUNDLE = [
  // ── The first days ──────────────────────────────────────────────
  { id: 'death-certificates', phase: 'FIRST', cat: 'finance', label: 'Order death certificates (get 10+ copies)', stakes: 'high', assistType: 'jurisdiction',
    why: "Nearly every task ahead — accounts, benefits, insurance — asks for one of these.",
    guidance: `1. Contact your local vital records office — ${officialLink('vital-records', 'the CDC directory')} lists the right office and its process for every state — or ask the funeral home to order them, which they often do as part of their services. 2. Request at least 10-15 certified copies — banks, insurance, Social Security, and creditors will all ask for originals. 3. Ask about rush processing if available. 4. There's a fee per copy, which your county sets — ask when you call. Shipping varies. 5. Keep the originals in a safe place; you'll reference them frequently over the next months.` },
  ...
  { id: 'notify-ssa', phase: 'WEEKS', cat: 'finance', label: 'Notify Social Security', stakes: 'high', assistType: 'guidance',
    ...
    guidance: `1. The funeral home usually reports the death for you — give them the Social Security number and ask them to confirm they've done it. ${officialLink('ssa-when-someone-dies', "SSA's page on what to do when someone dies")} walks through it. 2. If no funeral home is involved, call 1-800-772-1213 to report it yourself — this can't be done online. 3. Ask about ${officialLink('ssa-survivor', 'survivor benefits')} if you're a spouse, child, or dependent. 4. Request a clear explanation of which benefits stop and what, if anything, you're owed. 5. Keep your case number and the name of the representative you spoke with for follow-up.` },
  ...
  { id: 'forward-mail', phase: 'WEEKS', cat: 'home', label: 'Forward their mail', stakes: 'medium', assistType: 'guidance',
    ...
    guidance: `1. Use the ${officialLink('usps-change-of-address', 'official USPS change-of-address form')} or visit your local post office to set up forwarding from their address to yours — only go through usps.com, since look-alike sites charge far more for the same thing. 2. Online forwarding costs $1.10 for identity verification and takes about a week to start — in person at the post office is free. 3. Forwarding lasts 12 months for first-class mail (bills, important documents) — packages and magazines may not forward, so watch for important items. 4. Update their mailing address directly with banks, insurance, and government agencies rather than relying only on forwarding. 5. Set a calendar reminder before the 12 months expire to make sure nothing important is still going to the old address.` },
