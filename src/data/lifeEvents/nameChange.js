...
const BUNDLE = [
  { id: 'update-ssn-card', phase: 'CORE', cat: 'finance', label: 'Update your name with Social Security', stakes: 'high', assistType: 'guidance',
    ...
    guidance: "1. Gather your birth certificate, marriage certificate or court order, and valid ID. 2. Go to your local Social Security office or call 1-800-772-1213 to make an appointment. 3. Fill out Form SS-5 (you can start it online at ssa.gov). 4. Bring originals and copies of your documents — they'll return originals. 5. They'll mail your updated Social Security card in 1-2 weeks." },
  ...
  { id: 'update-passport', phase: 'REST', cat: 'finance', label: 'Update your passport', stakes: 'medium', assistType: 'guidance',
    ...
    guidance: "1. Get a certified copy of your court order or marriage certificate if you don't have one. 2. Go to travel.state.gov and download the name change form or apply online if eligible. 3. Gather your current passport, new court order, and ID. 4. Submit in person at a passport acceptance facility — you can find one via travel.state.gov. 5. Processing takes 4-6 weeks standard or 2-3 weeks expedited (for a fee). 6. Check the website for current processing times before you go." },
  ...
  { id: 'update-voter-registration', phase: 'REST', cat: 'finance', label: 'Update your voter registration', stakes: 'low', assistType: 'guidance',
    ...
    guidance: "1. Visit your state's secretary of state website and search for voter registration. 2. Most states let you update online with your driver's license number or last four digits of your SSN. 3. Enter your new legal name and confirm your registration. 4. Some states require you to re-register by mail or in person — check your state's process. 5. Print your updated registration confirmation if available." },
