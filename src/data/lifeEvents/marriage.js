...
const BUNDLE = [
  ...
  { id: 'marriage-license', phase: 'BEFORE', cat: 'finance', label: 'Get your marriage license', stakes: 'high', assistType: 'guidance', windowDays: 21,
    ...
    guidance: "1. Check your state's marriage license requirements online — rules vary on residency, waiting periods, and required documentation. 2. Visit your county courthouse or clerk's office with your partner, bringing your ID, birth certificate, and Social Security card. 3. Complete the application form and pay the fee (typically $30–$75). 4. Understand your state's waiting period — some are immediate, others require a 1–3 day waiting period before the ceremony. 5. Keep the signed license safe after the ceremony — your officiant will sign it, and you'll need it for vital records and name changes." },
  // ── After the wedding ───────────────────────────────────────────
  { id: 'marriage-certificates', phase: 'AFTER', cat: 'finance', label: 'Order certified copies of your marriage certificate', stakes: 'high', assistType: 'guidance',
    ...
    guidance: "1. Contact the vital records office in the county where you were married — this is usually the county clerk's office or health department. 2. Request 3–5 certified copies of your marriage certificate — you'll need them for name change, Social Security, insurance, and your will. 3. Expect to pay $15–$30 per copy and 1–2 weeks for processing. 4. Ask about rush processing if you need them sooner — fees may apply. 5. Keep the originals in a safe place and use copies for all applications." },
  { id: 'add-spouse-insurance', phase: 'AFTER', cat: 'health', label: 'Review health insurance — add your spouse or pick one plan', stakes: 'high', assistType: 'guidance',
    ...
    guidance: "1. Check whether your spouse has coverage through their employer — if so, compare plans side-by-side with yours on cost, deductible, and coverage. 2. If both of you work, decide whether to add them to your plan, use their plan, or keep separate coverage. 3. Contact your HR or insurance company within the first 30–60 days of marriage — marriage qualifies for special enrollment outside open enrollment. 4. Submit required documents: marriage certificate, spouse's ID, and employer information if they have coverage. 5. If your spouse has a pre-existing condition or takes regular medications, verify coverage details before finalizing the switch." },
  ...
  { id: 'update-tax-withholding', phase: 'AFTER', cat: 'finance', label: 'Update your tax withholding (W-4)', stakes: 'medium', assistType: 'guidance',
    ...
    guidance: "1. Get the current W-4 form from your HR department or download it from IRS.gov. 2. Use the IRS withholding calculator to estimate your new filing status (Married Filing Jointly or Married Filing Separately) and whether your withholding has changed. 3. Complete the form with your new filing status and any other changes, then submit it to payroll or HR. 4. Changes take effect on your next paycheck. 5. If you both work, talk with your spouse — one of you may claim all dependents and the other claim zero to avoid a big refund or tax bill." },
  { id: 'update-will', phase: 'AFTER', cat: 'finance', label: 'Create or update your will and estate documents', stakes: 'high', assistType: 'guidance_companies',
    ...
    guidance: "1. If you don't have a will, use an online service like LegalZoom or Nolo, or hire a lawyer — marriage is the right time to make one. 2. Name your spouse as executor and primary beneficiary, and choose contingent beneficiaries in case you both pass away. 3. Review and update any other estate documents like a power of attorney or healthcare directive — your spouse may need to be named there too. 4. Sign and notarize the documents according to your state's rules. 5. Store the originals in a safe deposit box or fireproof safe and tell your spouse where they are." },
