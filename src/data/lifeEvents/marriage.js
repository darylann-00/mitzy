...
const BUNDLE = [
  ...
  { id: 'marriage-certificates', phase: 'AFTER', cat: 'finance', label: 'Order certified copies of your marriage certificate', stakes: 'high', assistType: 'jurisdiction',
    ...
    guidance: "1. Contact the vital records office in the county where you were married — this is usually the county clerk's office or health department. 2. Request 3–5 certified copies of your marriage certificate — you'll need them for name change, Social Security, insurance, and your will. 3. There's a fee per copy, which your county sets — ask the clerk when you call. Processing usually takes 1–2 weeks. 4. Ask about rush processing if you need them sooner — fees may apply. 5. Keep the originals in a safe place and use copies for all applications." },
