...
const BUNDLE = [
  ...
  { id: 'childbirth-class', phase: 'T2', cat: 'health', label: 'Sign up for a childbirth class', stakes: 'medium', assistType: 'guidance', windowDays: 30,
    ...
    guidance: "1. Search for classes near you through your hospital, local birthing centers, independent instructors, or online platforms. 2. Classes run 4–6 weeks or can be one-day intensives — pick a format that fits your schedule. 3. Ask what topics are covered — labor positions, pain management options, what to expect, partner's role, early infant care. 4. Costs vary: many hospitals offer free classes; independent instructors charge $100–400. 5. Sign up early — popular classes fill up 8–12 weeks before your due date." },
  ...
  { id: 'birth-plan', phase: 'T3', cat: 'health', label: 'Write your birth plan', stakes: 'medium', assistType: 'guidance',
    ...
    guidance: "1. Use a birth plan template from your hospital or childbirth class to organize your preferences. 2. Include your goals for labor — natural labor, epidural, or open to circumstances — and pain management preferences. 3. Write your preferences on continuous monitoring, movement during labor, eating and drinking, timing of water breaking, episiotomy, and skin-to-skin immediately after birth. 4. Mention your partner's role, what support you want, and what should happen if baby needs extra care or you need a C-section. 5. Print multiple copies to bring to the hospital and give to your care team when you arrive in labor." },
  ...
  { id: 'update-life-insurance-bene', phase: 'POST', cat: 'finance', label: 'Update life insurance beneficiaries', stakes: 'high', assistType: 'guidance',
    ...
    guidance: "1. Pull up your life insurance policy documents or log into your insurer's online portal to find the beneficiary section. 2. Review who's currently listed as primary and contingent beneficiary — you likely want to include baby or ensure your spouse's will directs funds to baby. 3. You can name baby directly as beneficiary, name your spouse and let your will direct them to use the money for baby, or set up a trust (consult a lawyer for complex estates). 4. Contact your insurance company or log into their website to download a beneficiary change form — submit it signed and, if required, notarized. 5. Keep a copy of the confirmation and tell your spouse or executor the location of all your life insurance policies." },
  { id: 'update-retirement-bene', phase: 'POST', cat: 'finance', label: 'Update retirement account beneficiaries', stakes: 'high', assistType: 'guidance',
    ...
    guidance: "1. Log into each retirement account (401(k), IRA, Roth IRA, SEP-IRA, etc.) to check the current beneficiary designations. 2. You can name baby directly as beneficiary (money goes to a custodial account), name your spouse with instructions for baby, or name a trust. 3. Ask your plan administrator about custodial options — some plans allow you to name a custodian to manage money until the child reaches adulthood. 4. Download and submit the beneficiary change form signed and notarized (requirements vary by institution). 5. Keep confirmations and tell your executor or spouse the location of all retirement accounts and their beneficiary setup." },
];
