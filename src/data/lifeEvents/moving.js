...
const BUNDLE = [
  ...
  { id: 'mail-forwarding', phase: 'BEFORE', cat: 'home', label: 'Set up mail forwarding with USPS', stakes: 'high', assistType: 'guidance',
    ...
    guidance: `1. Use the ${officialLink('usps-change-of-address', 'official USPS change-of-address form')} or visit your local post office — go through usps.com directly, since look-alike sites charge many times more for the same filing. 2. You'll give your old and new addresses and verify your identity. 3. There's a small identity-verification fee online, and forwarding takes 1–2 weeks to activate. 4. Remember it only lasts 12 months — set a calendar reminder to renew or update addresses directly. 5. Still update critical addresses (banks, insurance, taxes) directly rather than relying only on mail forwarding.` },
  ...
  // ── After the move ──────────────────────────────────────────────
  { id: 'update-license', phase: 'AFTER', cat: 'car', label: "Update your driver's license with your new address", stakes: 'high', assistType: 'jurisdiction',
    why: "Most states set a deadline to update your address after a move — it's often needed for voter registration too.",
    guidance: `1. ${officialLink('dmv-directory', "Find your state's DMV site")} or visit a local office to see what you need — usually proof of residency and your current license. 2. Acceptable proof of residency includes a utility bill, lease, or mortgage statement with your new address. 3. You can renew online, by mail, or in person — online is fastest. 4. Some states charge a fee and issue a new photo ID. 5. Check your state's deadline when you apply — it varies by state. Allow 1–2 weeks for processing if you renew by mail or online.` },
  { id: 'register-car', phase: 'AFTER', cat: 'car', label: 'Register your car in the new state', stakes: 'high', assistType: 'jurisdiction',
    why: "States set deadlines to re-register — missing that deadline risks a ticket.",
    guidance: `1. ${officialLink('dmv-directory', "Look up your new state's DMV")} for registration requirements and the re-registration deadline — this varies by state. 2. Gather your current registration, proof of residency, vehicle title, and VIN (on your dashboard or title). 3. Ask the DMV if you need a vehicle inspection or emissions test — requirements vary by state. 4. Complete registration online, by mail, or in person — plates usually arrive by mail within 2 weeks. 5. Update your car insurance to reflect your new address and state before driving.` },
  { id: 'voter-registration', phase: 'AFTER', cat: 'finance', label: 'Register to vote at your new address', stakes: 'medium', assistType: 'jurisdiction',
    why: "You can't vote in your new district until you're registered there, and deadlines sneak up around elections.",
    guidance: `1. Start at ${officialLink('vote-register', 'vote.gov')}, which sends you to your own state's election office — registration takes about 5 minutes. 2. Check your state's deadline — most states require registration a certain number of days before Election Day. Register well in advance to be safe. 3. You can usually register when renewing your driver's license at the DMV. 4. After registering, check your voter status online to confirm you're on the rolls. 5. Look up your new polling place — it may be different from your old address.` },
  ...
  { id: 'register-pets', phase: 'AFTER', cat: 'health', label: 'Register or license pets in your new city or county', stakes: 'medium', assistType: 'jurisdiction',
    why: "Many cities require pet licenses — it's usually quick, and some shelters check for it.",
    guidance: "1. Visit your city or county website and search for 'pet licensing' or 'pet registration'. 2. Check what's required — some need proof of vaccination, microchip information, or vet records. 3. There's typically an annual fee to license your pet, which your city sets — call to ask. You'll get a tag with the license. 4. Some cities require a visit in person; others allow online registration. 5. Set a calendar reminder for annual renewal." },
