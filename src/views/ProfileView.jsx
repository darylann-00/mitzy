...
const CAR_DATA = {
  ...
  Cadillac:        ['CT4', 'CT5', 'Escalade', 'Lyriq', 'XT4', 'XT5'],
  Chevrolet:       ['Blazer', 'Bolt EV', 'Camaro', 'Colorado', 'Equinox', 'Malibu', 'Silverado 1500', 'Silverado 2500', 'Suburban', 'Tahoe', 'Traverse', 'Trax'],
  ...
  Kia:             ['Carnival', 'EV6', 'EV9', 'Forte', 'K5', 'Niro EV', 'Soul', 'Sorento', 'Sportage', 'Stinger', 'Telluride'],
